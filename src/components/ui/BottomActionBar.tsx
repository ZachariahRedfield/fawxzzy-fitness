  ...
  const content = useMemo(() => (
    ...
    >
      <div className={cn("mx-auto w-full max-w-md px-4 pointer-events-auto")}>
        <div
          className={cn(
            "flex items-center justify-center gap-4 rounded-xl bg-[rgb(var(--glass-tint-rgb)/0.20)] px-4 pt-2 pb-[calc(env(safe-area-inset-bottom,0px)+3px)] shadow-[0_6px_16px_rgb(0_0_0/0.35)] backdrop-blur-md",
            "[&>*]:min-h-[44px] [&>*]:flex-1",
            innerClassName,
          )}
        >
